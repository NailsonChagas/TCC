...
2. Revisão Bibliográfica
   ...
   2.1 Conversores Eletrônicos de Potência
       2.1.3 Conversor Buck
           ...
           - Equacionamento matemático dos estados
           - Modelagem (ex: média no espaço de estados)
   ...
   2.3 Desenvolvimento Baseado em Modelos (MBD)
       ...
       2.3.2 Ciclo em V (V-Model)
       2.3.3 Testes X-in-the-Loop (MIL, SIL, PIL, HIL)
       2.3.4 Reutilização de testes
   ...
   2.4 Simulação Hardware-in-the-Loop (HIL)
       2.4.1 Conceito e fundamentos
       2.4.2 Aplicações em eletrônica de potência
       2.4.3 Requisitos de tempo real
